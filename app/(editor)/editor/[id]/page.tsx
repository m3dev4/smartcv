  ...
  return (
    <ResumeProvider resumeId={resumeId} templateType={templateType}>
      <div className="flex h-screen w-full bg-slate-100 dark:bg-slate-900">
        ...
        {/* Main Content */}
        <div className="flex flex-col flex-1 lg:mx-0 xl:mx-auto xl:max-w-screen-xl w-full overflow-hidden">
          {' '}
          {/* Adjusted margins and max-width */}
          <EditorToolbar
            ...
            <div
              className={
                `transition-all duration-300 ease-in-out fixed lg:static inset-y-0 right-0 z-30 lg:z-auto 
                          ...
                          lg:transform-none ${
                            propertiesPanelOpen ? 'lg:flex lg:flex-col' : 'lg:hidden'
                          }` // Manages visibility and slide-in/out for mobile
              }
            >
              {propertiesPanelOpen && (
