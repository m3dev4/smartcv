            ...
            <div className="flex flex-1 flex-col items-center justify-center">
                <div className="w-full py-5">
                    ...
                    <p className="text-sm leading-relaxed py-2">
                        Reactive Resume est le fruit d’un travail passionné et rigoureux, ayant
                        donné naissance à de nombreuses idées et fonctionnalités soigneusement
                        améliorées pour tendre vers (presque) la perfection.
                    </p>
                </div>
            ...
            <div className="flex flex-1 flex-col items-center justify-center mt-24 mb-12">
                <div className="w-full text-center max-w-3xl mx-auto">
                    ...
                    <p className="text-lg leading-relaxed">
                        Démarquez-vous dans un marché compétitif avec un CV qui reflète parfaitement
